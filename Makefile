...
pres:
	...
	pandoc -s content/fundamentals/workspaces-vs-repositories/index.md -o test.html --resource-path content/fundamentals/workspaces-vs-repositories/ --html-q-tags ;pandoc -s test.html  -o test.pptx --resource-path content/fundamentals/workspaces-vs-repositories/